...
public class LuaScriptPeekTest extends LuaScriptBaseTest {
	...
	public void testMissingCountArgsThrowsException() throws LuaScriptException {
		...
		testArgsException(keys, emptyValues,
	...
	public void testInvalidCountArgsThrowsException() throws LuaScriptException {
		List<String> keys = Arrays.asList(TEST_QUEUE);
		List<String> badValues = Arrays.asList("test-count");

		testArgsException(keys, badValues,
	...
	public void testMissingNowArgsThrowsException() throws LuaScriptException {
		List<String> keys = Arrays.asList(TEST_QUEUE);
		List<String> badValues = Arrays.asList("1");
	...
	public void testInvalidNowArgsThrowsException() throws LuaScriptException {
		List<String> keys = Arrays.asList(TEST_QUEUE);
		List<String> badValues = Arrays.asList("1", "test-now");
	...
	@Test
	public void testPeekASingleJob() throws LuaScriptException {
		String jid1 = addNewTestJob();
		String jid2 = addJob(UUID.randomUUID().toString());

		List<String> keys = Arrays.asList(TEST_QUEUE);
		List<String> args = Arrays
				.asList("1", JQlessClient.getCurrentSeconds());
	...
	@Test
	public void testPeekJobInsertedWithHigherPriority()
			throws LuaScriptException {
		String jid1 = addNewTestJob();
	...
	@Test
	public void testPeekMultipleJobs() throws LuaScriptException {
		String jid1 = addNewTestJob();
		String jid2 = addJob(UUID.randomUUID().toString());

		List<String> keys = Arrays.asList(TEST_QUEUE);
		List<String> args = Arrays
				.asList("2", JQlessClient.getCurrentSeconds());
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testPeekDoesNotRemoveItemsFromList() throws LuaScriptException {
		String jid1 = addNewTestJob();
		String jid2 = addJob(UUID.randomUUID().toString());
